...
components:
  ...
  profile-left-wings: calc(var(--column-unit) * 1)
...
code {
  ...
  padding: var(--spacing-pixel) calc(var(--spacing-unit) * 1);
...
.text-shadow-outline {
  text-shadow:
    var(--spacing-pixel) var(--spacing-pixel) 0 var(--void-black),
    calc(var(--spacing-pixel) * -1) var(--spacing-pixel) 0 var(--void-black),
    var(--spacing-pixel) calc(var(--spacing-pixel) * -1) 0 var(--void-black),
    calc(var(--spacing-pixel) * -1) calc(var(--spacing-pixel) * -1) 0 var(--void-black),
    0 0 calc(var(--spacing-unit) * 4) var(--void-black);
}
