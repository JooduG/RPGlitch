...
/**
 * A raw narrative log entry for memory compression.
 */
interface LogEntry {
  turn: number;
  text: string;
  tags?: string[];
  /** High-level summary generated by the Archivist */
  summary?: string;
  createdAt: number;
}
...
interface ApplicationState {
  ...
  selectedFractal: number | string | null;
