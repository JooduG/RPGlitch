...
class PerchanceBridge {
  ...
  constructor() {
    this._mockMode =
      ...
      typeof window.oc !== "object" ||
      window.oc === null ||
      window.oc instanceof Element ||
      window.oc instanceof Node ||
  ...
  on(event, callback) {
    ...
    try {
      if (
        typeof window.oc.thread !== "object" ||
        window.oc.thread === null ||
        window.oc.thread instanceof Element ||
        window.oc.thread instanceof Node ||
        (typeof HTMLCollection !== "undefined" && window.oc.thread instanceof HTMLCollection) ||
        (typeof NodeList !== "undefined" && window.oc.thread instanceof NodeList)
      ) {
