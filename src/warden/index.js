...
// Sub-Modules
import * as Security from "./logic/security.js";
import * as Physics from "./logic/physics.js";
...
${content}${visualAuth}
  ...
  parse: (text) => parsePhysicsResponse(text),
  // template: Deprecated (Use ContextBuilder)
  // compose: Deprecated (Use ContextBuilder)
};
