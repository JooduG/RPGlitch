...
export const PALETTE_VARS = {
  ...
  "#ec4899": "var(--color-hot-pink)",
  "#fde047": "var(--color-lemon-yellow)",
  "#84cc16": "var(--color-lime-green)",
  "#14b8a6": "var(--color-neon-teal)",
  "#3b82f6": "var(--color-ocean-blue)",
  "#fbbf24": "var(--color-pumpkin-amber)",
  "#fff": "var(--color-pure-white)",
  "#a855f7": "var(--color-royal-purple)",
  "#f97316": "var(--color-sunset-orange)",
