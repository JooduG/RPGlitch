...
describe("session-checkpoint", () => {
  ...
  it("round-trips a checkpoint through sessionStorage", async () => {
    const { save_session_checkpoint, load_session_checkpoint } = await import("./session.js");
  ...
  it("clears the checkpoint", async () => {
    const { save_session_checkpoint, load_session_checkpoint, clear_session_checkpoint } = await import("./session.js");
  ...
  it("returns null when nothing is stored", async () => {
    const { load_session_checkpoint } = await import("./session.js");
    expect(load_session_checkpoint()).toBeNull();
  });
  ...
  it("writes to window.name when sessionStorage is blocked", async () => {
    ...
    const { save_session_checkpoint } = await import("./session.js");
