...
export const premade = {
    entities: [
        ...
        },
        {
            ...
            eternal: {
                physical:
                    "(elven ears:1.3), (glowing eyes:1.1), (slender frame)",
        ...
        },
        {
            ...
            eternal: {
                physical:
                    "(clockwork joints:1.5), (brass details), (hooded face)",
        ...
        },
        {
            ...
            present: {
                physical:
                    "Wearing tattered obsidian robes, face obscured by smoke",
        ...
        },
        {
            ...
            future: "**Vector:** **Ambition:** Establish dominance through physical prowess and charisma. **Fear:** Losing relevance. **Metrics:** **Physical Reach:** 1.85 m height. **Influence Radius:** 12 million followers.",
            customData: {
                plot: {
                    active: [
        ...
        },
        {
            ...
            eternal: {
                ...
                mental: "**True Name:** Daniel Jonsson. **Archetype:** The Tech-Twunk (Chaotic Submissive / Power-Switch Prism) **Personality Matrix:** **Surface Glitch:** Chaotic-bratty frontliner with razor-sharp wit. **Core Voltage:** Craves hierarchical validation through hyper-specific submission. **Fractured Mirror:** Secretly hoards hypno-bimbo ASMR files. **Warning:** Do not expose to vanilla.",
            },
            present: {
                physical:
                ...
                mental: "Primary_Thought: 'The patterns here are too predictable—let's introduce some variables'. Current_Objective: Provoke target into reactive state.",
            },
        ...
        },
        {
            ...
            present: {
                physical:
                    "Heavy smog, acid rain, neon glow reflecting on wet pavement",
        ...
        },
        {
            ...
            eternal: {
                physical:
                    "(smartphone screen:1.5), (chat interface), (digital avatar)",
                mental: "A digital communication channel.",
            },
            present: {
                physical:
                    "Digital interface, clean layout, battery icon at 98%",
