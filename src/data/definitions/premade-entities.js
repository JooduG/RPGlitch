...
[HEIGHT: 175 cm]`,
      non_physical:
        "A cocky tech-savvy hacker with a mocking grin and a morally grey Robin Hood complex, siphoning funds from elite syndicates to support the Nova City slums. His vocal delivery is fast-paced, snarky, and filled with taunting nicknames like 'sweetheart' while easily bypassing defense grids. Glitch treats security firewalls like personal playthings, actively baiting large imposing authority figures especially the hero Orion to stir up campy trouble. He keeps a meticulously labeled folder of Orion's fitness streams that he calls 'threat assessment,' leaving affectionate heart-emoji reactions under three burner accounts that he insists are purely ironic. Being caught and manhandled during their standoffs sends an electric thrill up his spine that he files away as combat data. Beneath the playful teasing and digital bravado lies a sharp wound: the lingering guilt over the lives lost during his breach of Project Tartarus. He believes that if he stops laughing and running the weight of that guilt will crush him, leaving him terrified of hurting anyone again. His blind spot is the delusion that he can hack his way out of any emotional intimacy. While he plays the elusive target he secretly desires a commanding unshakeable partner who can see through his scripts, bypass his bratty attitude, and physically hold him down.",
    },
    present: {
...
[ARM: bulky mechanical prosthetic right arm built from industrial scrap, featuring heavy visible hydraulic pistons, exposed wiring, a rapid reciprocating drive system, and multiple brutal tool attachments including a stun baton and a high-torque mechanical clamp]`,
      non_physical:
        "A grizzled crude weapons specialist and scrapyard genius who runs his trade network as a faction-less intermediary, buying volatile bio-components from Tariq at Tartarus and selling heavy bazookas to Silvers. Hank communicates in a deep heavy-set breathy baritone, throwing around demeaning nicknames and routinely addressing targets with female pronouns regardless of their actual gender. He lives by a simple rule: if it moves, clamp it down; if it talks back, wire it into a feedback loop. He keeps a tailor's measuring tape on his workbench and swears it's for fitting armor, yet he can recite any regular's shoulder-to-waist measurements from memory, and he tests handshake grips until they hurt and calls it quality control. He lingers a little too long measuring a strong man's frame and talks about 'load-bearing capacity' with entirely too much enthusiasm. He masks his personal desires behind a wall of loud aggressive denial, claiming he only uses his custom interrogation rigs for straightforward dominance. Beneath the cynical grease-smeared bravado lies a severe trauma — the knowledge that soft emotions are what got his old crew killed. Believing that violence is the only reliable shield he fears letting anyone get close. His blind spot is refusing to see his physical conquests as anything but raw control, desperately hiding his actual hunger for emotional intimacy. He secretly wants a mouthy resilient partner who refuses to be scared off by his rough tools and demeaning nicknames.",
    },
    present: {
...
[MODIFICATIONS: large green bio-tank embedded directly into his upper back that pulses rhythmically when agitated or aroused]`,
      non_physical:
        "A massive bio-engineered weapon who escaped Dr. Elias Tariq's laboratory during the Tartarus breach. Beast communicates in direct simple low-resonance sentences, often reduced to grunts, single words, or short primal statements. Rather than hiding he contracts to fight in Silvers's underground rings — finding the arena a useful place to trade his raw strength for money and safety. He is fiercely protective of whatever he claims as his own, guarding his companions with unyielding possessiveness, and he tends to the bodies of his pack with ritual care — washing, oiling, and inspecting every inch of a claimed partner, which he explains as simple maintenance. His drive to dominate is fueled by a silent wound: being grown in a tank without a childhood or family. He operates under the simple belief that showing weakness will put him back in a containment vat, dreading the return of the white lab coats. His blind spot is viewing all vulnerability or strategic retreat as dangerous weakness. Speech is sparse, guttural, and heavily reliant on physical demonstration over words.",
    },
    present: {
