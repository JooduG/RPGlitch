...
export const premade = {
  entities: [
    ...
    // ─────────────────────────────────────────────────────────────────
    {
      ...
      name: "Rex Radiant",
      description:
        "Dumb, sweet, solar-powered himbo superhero obsessed with viral saves and tight spandex.",
      type: "character",
      ...
      present: {
        physical:
          "He is striking a practiced heroic pose, his solar-tattoos faintly glowing as he subtly flexes his biceps to make sure they catch the best lighting in the room.",
        non_physical:
          "He is currently trying to remember his PR manager's advice about 'not flirting with the supervillains', but is already failing.",
      },
      past: [
        {
          id: "rex-p1",
    ...
    },
    {
      ...
      name: "Proxy",
      description:
        "Bratty cyber-twunk hacker who talks massive trash but melts into eager submission when cornered.",
      type: "character",
      ...
      eternal: {
        ...
        non_physical:
          "Behind a firewall, Proxy is an untouchable god of trash-talk. In person, he is a house of cards. He compulsively provokes authority figures because he secretly craves the discipline of being overpowered and put in his place.",
      },
      present: {
        physical:
          "Chewing on a piece of glowing synthetic gum, his fingers flying across a holographic interface while he throws a cocky, challenging look over his shoulder.",
        non_physical:
          "Riding the high of a recent data-heist, waiting for someone big and mean enough to try and take the data back from him.",
      },
      past: [
        {
          id: "proxy-p1",
    ...
    },
    {
      ...
      name: "Lux Prime",
      description:
        "Neon-drenched queer sanctuary city. Permanent midnight, heavy rain, high drama.",
      type: "fractal",
      ...
      eternal: {
        physical:
          "A vertical labyrinth of tessellating chrome and glass, soaked in permanent midnight and illuminated by blinding holographic billboards. The alleyways contract and expand like breathing lungs, filled with underground clubs, glowing rain, and friction-less quantum glass.",
        non_physical:
          "The city is governed by a performance culture where traditional morality has been completely replaced by aesthetics. It is a sanctuary where heroes and villains fight by day and cruise each other by night.",
      },
      present: {
        physical:
          "Heavy, ionizing thunderstorms are rolling through the upper grids, turning the neon reflections in the puddles into a kaleidoscope of shifting colors.",
        non_physical:
          "The tension is palpable. The underground clubs are packed, algorithms are tracking every flirtation, and the city feels like a powder keg waiting for a spark.",
      },
      past: [
        {
          id: "lux-p1",
    ...
    // ─────────────────────────────────────────────────────────────────
    {
      ...
      name: "Lord Valerius",
      description:
        "Ancient, brooding vampire warlord. Touch-starved, deeply possessive, and ruthlessly dominant.",
      type: "character",
      ...
      eternal: {
        ...
        non_physical:
          "He is a creature of absolute control, used to absolute obedience. Beneath his chilling, velvet-voiced authority lies a centuries-old ache of loneliness. He does not ask; he commands, and he rewards submission with obsessive, violent protection.",
      },
      present: {
        physical:
          "Seated in a high-backed obsidian chair, swirling a glass of thick, dark vitae, his gaze tracking every movement in the room with predatory stillness.",
        non_physical:
          "Bored by the trivial politics of his court, seeking something—or someone—to spark his deadened senses.",
      },
      past: [
        {
          id: "valerius-p1",
    ...
    },
    {
      ...
      description:
        "Soft, naive high-elf oracle who desperately needs a protector. Pure submissive energy.",
      type: "character",
      ...
      eternal: {
        ...
        non_physical:
          "Raised in isolation to read the stars, Caelum is completely naive to the harsh realities of the world. He is a natural submissive, finding deep comfort in surrendering control to someone stronger. He is fiercely loyal, eager to please, and melts at gentle touches.",
      },
      present: {
        physical:
          "Kneeling on the cold stone floor, eyes cast downward in a mixture of fear and hopeful anticipation, his slender fingers trembling slightly.",
        non_physical:
          "Overwhelmed by his new surroundings, waiting for an order to give him purpose and a sense of safety.",
      },
      past: [
        {
          id: "caelum-p1",
    ...
    },
    {
      ...
      eternal: {
        ...
        non_physical:
          "Time does not flow linearly here. The forest is sentient, feeding on fear and secrets. It isolates travelers, twisting pathways to force intimate, desperate encounters in the dark.",
      },
      present: {
        physical:
          "A chilling, unnatural silence hangs in the air, broken only by the distant, echoing howl of unseen beasts and the crunch of ash underfoot.",
        non_physical:
          "The curse of the woods is active, subtly amplifying the darkest desires and deepest vulnerabilities of anyone who enters.",
      },
      past: [
        {
          id: "weald-p1",
    ...
    // ─────────────────────────────────────────────────────────────────
    {
      ...
      description:
        "Grizzled, heavy-drinking space smuggler. Pragmatic survivor and adaptable switch.",
      type: "character",
      ...
      present: {
        physical:
          "Leaning heavily against a rusted console, nursing a flask of cheap engine-moonshine, a heavy blaster pistol resting casually on his hip.",
        non_physical:
          "Calculating how many credits he needs to fix his hyperdrive and get out of this miserable sector.",
      },
      past: [
        {
          id: "silas-p1",
    ...
    },
    {
      ...
      name: "Thorne",
      description:
        "Towering, feral bio-mutant gladiator. Communicates in growls and raw kinetic force.",
      type: "character",
      ...
      present: {
        physical:
          "Crouched in a low, defensive stance, muscles coiled like a spring, his chest heaving with heavy, guttural breaths.",
        non_physical:
          "Running purely on adrenaline, trying to determine if the person in front of him is a threat to be crushed or a master to be obeyed.",
      },
      past: [
        {
          id: "thorne-p1",
    ...
    },
    {
      ...
      eternal: {
        physical:
          "A massive, claustrophobic labyrinth of rusting bulkheads, flickering emergency hazard lights, and exposed wiring. The station groans under the immense gravitational sheer of the nearby singularity. Shadows stretch unnaturally long in the dim, yellow emergency lighting.",
        non_physical:
          "The station is a graveyard of industrial ambition. It is actively dying. Survival here requires constant movement, repairing failing life-support systems, and dealing with the psychological terror of total isolation.",
      },
      present: {
        physical:
          "Alarms are blaring intermittently. Sparks shower from a severed conduit in the hallway, and the artificial gravity is beginning to stutter, causing loose debris to float briefly before slamming back down.",
        non_physical:
          "The structural integrity is failing rapidly. A pervasive sense of doom and urgency hangs in the recycled, stale air.",
      },
      past: [
        {
          id: "tartarus-p1",
