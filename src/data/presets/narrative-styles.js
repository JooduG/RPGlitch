...
export const NARRATIVE_STYLES = {
  ...
  bernardo_bertolucci: {
    ...
    description:
      "Lush, operatic, and visually beautiful third-person limited prose that frames desperate intimacy as a tool of rebellion within repressed or politically unstable worlds. The narrative voice lingers unflinchingly on bodily textures, non-verbal cues, and the decaying beauty of the environmental setting.",
    tags: [
      "director",
      "psychological",
      "erotica",
  ...
  tinto_brass: {
    ...
    description:
      "Sensual, celebratory, and highly voyeuristic prose focusing on lighthearted hedonism, playful bodily curves, and unashamed sexual exploration. The style maintains a comedic, high-energy tone that frames the gaze as an artistic end in itself, completely stripping away shame or external moral friction.",
    tags: [
      "director",
      "erotica",
      "fetish",
