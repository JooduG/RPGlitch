...
export const TOKENS = {
  ...
  "danger-hover-shadow":
    "0 0 var(--spacing-4) rgb(from var(--crimson-red) r g b / var(--opacity-muted))",
  "deep-indigo": "#818cf8",
  ...
  "shadow-ghost":
    "0 var(--spacing-pixel) var(--spacing-2px) rgb(from var(--void-black) r g b / var(--opacity-ghost))",
  "shadow-heavy":
    "0 var(--spacing-2) var(--spacing-8) rgb(from var(--void-black) r g b / var(--opacity-muted))",
  "shadow-light":
    "0 var(--spacing-1) var(--spacing-3) rgb(from var(--void-black) r g b / var(--opacity-whisper))",
