...
import { generate_uuid as generateUUID, create_job_queue, state_bridge, get_value } from "@utils";
import { visual_engine, resolve_image_trigger, spawn_image_beat, sweep_stale_ghosts, IMAGE_RESOLVE_TIMEOUT_MS } from "@media";
import { strip_cognition_blocks, check_refusal, clean_text } from "./parser.js";
...
import { render_terse_director_task } from "./prompts/story-prompts.js";
...
import { prune, temporal_engine, resolve_vector_pool } from "./temporal-pipeline.js";
...
export const context_builder = {
  ...
  async build_context(input, type = "simulation", simulation_log = []) {
    ...
    // 1.5. NPC WORLD CAST — hydrate secondary characters for Director
