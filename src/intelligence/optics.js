/**
 * src/intelligence/optics.js
 * ============================================================================
 * 👁️ SENSORY CORTEX OPTICS PIPELINE — Visual Prompt Compilation & Protocols
 * ============================================================================
 *
 ...
 * 2. Multi-Tier Prompt Templates (`render_optics_prompt`, `render_visual_enhancement`):
 *    - Generates sensory cortex system prompts for solo entity portraits, environmental scenes, and group shots.
 *    - Injects dynamic camera framing based on character dynamics (intensity, chaos, affinity).
 *
 * Purity Mandate:
 * - Pure template synthesis and string formatting algorithms.
 * - Leaves network generation to transport.js and visual queuing to visual.svelte.js.
 * ============================================================================
 */
...
import { resolve_visual_engine_tokens, strip_visual_excluded } from "../media/image-aesthetics.js";
...
// ============================================================================
// [SECTION 2: OPTICS PROMPT COMPILATION]
// ============================================================================
 ...
 * @returns {string}
 */
export function render_optics_prompt(target_type, raw_intent, context = {}) {
...
/**
 * CHANGELOG:
 * - 2026-09-18: Absorbed and integrated into Intelligence Kernel from src/media/image-prompts.js: (1) 5-phase Optics Builder protocol; (2) Cinematography framing; (3) Multi-tier prompt compilation (render_optics_prompt, render_visual_enhancement); (4) Response parsers relocated to src/intelligence/parser.js.
 */
