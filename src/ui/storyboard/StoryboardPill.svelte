...
<div class="pill-container">
  <GlassPill class="unified-capsule interactable">
    {#snippet left()}
      <Button
...
<style>
  ...
  :global(.unified-capsule .capsule-flank.wrapper),
  :global(.unified-capsule .capsule-action.wrapper) {
  ...
  :global(.unified-capsule .wrapper:hover:not(:disabled)) {
    background: transparent;
