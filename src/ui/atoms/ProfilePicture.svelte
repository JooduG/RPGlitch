  ...
  >
    <div
      class="
        ...
        select-none
        [text-shadow:1px_1px_0_#000,-1px_1px_0_#000,1px_-1px_0_#000,-1px_-1px_0_#000,0_0_8px_var(--signature-color,#555d66),0_0_24px_rgba(from_var(--signature-color,#555d66)_r_g_b/0.6)]
      "
    >
      {initials}
    </div>
