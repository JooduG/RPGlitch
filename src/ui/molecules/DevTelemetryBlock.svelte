<script>
  ...
  import DevTelemetryUpdates from "./DevTelemetryUpdates.svelte";
  import DevTelemetryVector from "./DevTelemetryVector.svelte";
    ...
    >
      ...
      >
        {#if meta.type === "MEMORY_FORMATION" || meta.type === "VECTOR_RESOLUTION"}
          <DevTelemetryVector {meta} {forged_vectors} {get_entity_name} />
        {:else}
          ...
          <DevTelemetryUpdates {entity_blocks} {get_entity_name} />
        {/if}
