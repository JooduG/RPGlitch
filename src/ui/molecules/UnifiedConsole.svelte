...
<style>
  ...
  :global([data-bits-accordion-content]) {
    overflow: hidden;
  }

  :global([data-accordion-content][data-state="open"]),
  :global([data-bits-accordion-content][data-state="open"]) {
    animation: accordion-slide-down 500ms cubic-bezier(0.4, 0, 0.2, 1) forwards;
  }

  :global([data-accordion-content][data-state="closed"]),
  :global([data-bits-accordion-content][data-state="closed"]) {
    animation: accordion-slide-up 500ms cubic-bezier(0.4, 0, 0.2, 1) forwards;
  }
