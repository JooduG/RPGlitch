...
<style>
  ...
  /* --- Interactive Storymode Focus Expansion --- */
  .root.is-storymode.is-focused {
  ...
  /* --- Global Child Integrations & Micro-Layouts --- */
  :global(.action-btn.is-ready h6) {
