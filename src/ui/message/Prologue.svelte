<script>
  /**
   * @file src/ui/message/Prologue.svelte
   * 🎬 PROLOGUE ENTITY TRIO
   * The story title (Satisfy script) plus the three entity cards (ai / fractal /
   * user) that fly into place during the begin-story transition.
   */
...
{#if app.story_title}
  <h2 class="mb-4 text-center text-[clamp(1.3rem,2.8vw,2.2rem)] font-normal text-balance" style="font-family: Satisfy, cursive;" data-msg-title>
...
{/if}
<div class="mb-4 flex h-character-card-height w-full items-stretch gap-2 md:gap-4" data-msg-prologue>
