<script>
  /**
   * @file src/ui/message/PrologueEpilogue.svelte
   * 🎬 PROLOGUE / EPILOGUE ENTITY TRIO
...
{#if app.story_title}
  <h2
    ...
    data-msg-title={is_prologue ? "" : undefined}
  >
...
{/if}
<div class="mb-4 flex h-character-card-height w-full items-stretch gap-2 md:gap-4" data-msg-prologue={is_prologue ? "" : undefined}>
