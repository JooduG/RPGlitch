...
export const handleAsyncError = async (asyncFn, options = {}) => {
  ...
  try {
    ...
    if (showAlert)
      // import("../js/mesmer/ui/core/orchestrator.js").then((m) =>
      //   m.showAlert("Error", errorMessage),
      // );
      log("ShowAlert (Legacy) suppressed:", errorMessage);
...
// --- Dynamic Sampling moved to Warden/Physics ---
import { calculateBlendedParams } from "../warden/logic/physics.js";
