...
describe("IntelligenceService Orchestration", () => {
    beforeEach(() => {
        vi.resetAllMocks()
        runtime.turn = 0
    })
    ...
    it("should execute a full narrative turn", async () => {
        ...
        const result = await IntelligenceService.executeTurn("story-123", { input: "Hi" })
    ...
    it("should execute a prologue", async () => {
        ...
        await IntelligenceService.executePrologue("story-123")
    ...
    it("should execute an epilogue", async () => {
        ...
        const result = await IntelligenceService.executeEpilogue("story-123")
