...
describe('ImageGlitch', () => {
  ...
  test('should generate an image when the form is filled and the button is clicked', (done) => {
    ...
    // Use a MutationObserver to wait for the image to be added to the output area
