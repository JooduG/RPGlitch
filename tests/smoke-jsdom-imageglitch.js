...
const OUTPUT_HTML = path.resolve(__dirname, '..', 'build', 'output', 'imageglitch.html');

if (!fs.existsSync(OUTPUT_HTML)) {
    console.error(`❌ Missing ${path.relative(process.cwd(), OUTPUT_HTML)}. Run \`npm run build:imageglitch\` first.`);
    process.exit(2);
}
