...
// Mock ui-views
jest.mock("../apps/rpglitch/js/ui-views.js", () => ({
  router: {
    handleRoute: jest.fn(),
  },
}));
...
import { StoryOptionsController } from "../apps/rpglitch/js/settings.js";
import { applyPatch } from "../apps/rpglitch/js/app-state.js";
