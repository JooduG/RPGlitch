---
description: Unified client-side storage strategy covering localStorage, IndexedDB, and Dexie.js with clear decision frameworks for when to use each approach.
globs: **/*.js
alwaysApply: false
---
