---
description: Comprehensive optimization strategies for the Memory Bank system focusing on token efficiency, hierarchical rule structure, and progressive documentation approaches.
alwaysApply: false
---
