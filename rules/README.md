...
1. [**AGENTS.md**](../AGENTS.md): The Master Protocol. Defines your core identity, cognitive framework, and operational loop.  
2. [**rules/system-architecture.md**](./architecture.md): The Repository Blueprint. Defines the high-level structure and purpose of all directories.
...
| :---- | :---- |
| Any Perchance application (/apps/\*) | ➡️ [**/rules/perchance-development-guide.md**](./perchance.md) |
| Using or configuring MCP servers | ➡️ [**/rules/mcp-guide.md**](./mcp.md) |
| Writing or modifying JavaScript (.js) | ➡️ [**/rules/js-guide.md**](./js.md) |
| Writing or modifying SCSS (.scss) | ➡️ [**/rules/scss-style-guide.md**](./scss.md) |
| Writing or modifying HTML (.html) | ➡️ [**/rules/html-best-practises.md**](./html.md) |
| Writing any documentation (.md) | ➡️ [**/rules/system-documentation-guide.md**](./documentation.md) |
