---
description: Principles and best practices for using IndexedDB in Perchance and related web applications, including versioning, upgrades, and recommended libraries.
globs: **/*.js
alwaysApply: false
---
