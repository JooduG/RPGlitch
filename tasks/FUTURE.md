...
| --------------------------------------------------------- | ---------------------------------------------- | -------- | --------- | ------------------------------------------------------------------------------------------------------- |
| `refactor-vite-8`                                         | Vite 8 Rolldown Migration                      | P0       | 🔄 Active | Migrate bundler to Rolldown while maintaining single-file generation.                                   |
| `view-transition-guard-2026-06-02`                        | View Transition Guard & Collision Fix          | P0       | ✅ Done   | Implement centralized guardedTransition to prevent InvalidStateError and fix duplicate name collisions. |
