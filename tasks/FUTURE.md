...
- **Track**: `agent-system-alignment-2026-05-24`
- **Objective**: Synchronize `.agents/` sector config, motion & svelte guidelines, and harden CSS token audit scripts to prevent regression.

## 🗺️ Roadmap (Tracks)

| Track ID                                                  | Name                                           | Priority | Status    | Objective                                                                                           |
| :-------------------------------------------------------- | :--------------------------------------------- | :------- | :-------- | :-------------------------------------------------------------------------------------------------- |
| `agent-system-alignment-2026-05-24`                       | Agent System Alignment                         | P0       | 🔄 Active | Synchronize .agents config, motion & svelte guidelines, and harden token checkers.                  |
