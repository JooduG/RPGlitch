...
- [x] `track-npc-expansion-2026-08-14`: Multi-NPC living-world ecosystem (3-tier world roster, Stage Spotlight `in_scene_npc_ids` + Director choreography, compact `<WORLD_CAST>` signatures, relational mesh, Epistemic Horizon rules, 1.3x in-scene RAG boost, Director NPC delegation, and multi-voice Kokoro TTS). Archived to `archive/2026-08/2026-08-21-track-npc-expansion.md`.
