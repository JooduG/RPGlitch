...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | --------- |
| 2026-05-31T07:07:00+02:00 | Move check-unused-tokens.js to agents/ folder, fix JSDoc/TS index and array implicit warnings, and run clean verification suite.                                                                                | javascript + css           | ✅ Done   |
| 2026-05-31T07:05:00+02:00 | Create self-contained check-unused-tokens.js tool to find all unused design tokens from design.css across the src/ codebase.                                                                                    | javascript + css           | ✅ Done   |
| 2026-05-31T06:56:00+02:00 | Increase base secondary-desc max-height on EntityCard to avoid clipping line-clamp ellipsis for storyboard card descriptions.                                                                                   | css + test                 | ✅ Done   |
| 2026-05-31T06:50:00+02:00 | Implement robust 200ms selection fallback timeout in EntityCard.svelte to guarantee click triggers fire when animationend event is lost.                                                                        | svelte + test              | ✅ Done   |
| 2026-05-31T06:48:00+02:00 | Style empty placeholder card typography (primary-title) to match placeholder icons' color, opacity, hover transitions, and styles.                                                                              | css + svelte               | ✅ Done   |
| 2026-05-31T04:42:00+02:00 | Prevent view transition collisions inside the drawer tray, allow scale transforms to overflow without clipping, and restore typography bounds.                                                                  | svelte + css + javascript  | ✅ Done   |
| 2026-05-31T04:31:00+02:00 | Polish empty card HUD panels, transition backdrops inside transitioning divs, and secure launch timing in view transitions.                                                                                     | svelte + css + javascript  | ✅ Done   |
| 2026-05-31T04:14:00+02:00 | Implement Inertial Rack-Pull Selection Motion (Phase A) on EntityCard.svelte, resolve test timers & stylelint spacing, and verify.                                                                              | svelte + css + javascript  | ✅ Done   |
| 2026-05-31T03:53:00+02:00 | Relocate Drawer to src/ui/atoms/Drawer.svelte, upgrade layout transition to Svelte 5 spring physics, clean up obsolete aliases, and verify.                                                                     | svelte + css + javascript  | ✅ Done   |
