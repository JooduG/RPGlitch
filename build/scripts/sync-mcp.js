...
function syncMcp() {
    ...
    if (!masterMcp || !masterMcp.mcpServers) {
        console.warn('⚠️  Master MCP config not found or is missing "mcpServers" property. Skipping MCP sync.');
        return;
    }
    ...
    const clientMcpTemplate = { ...masterMcp, mcpServers: flattenedServers };
