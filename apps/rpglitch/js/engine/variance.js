...
const DIRECTOR_NOTES = {
  ...
  "The Internal State":
    "Ignore the external world. Focus entirely on the character's visceral, somatic emotional reaction.",
  "The Prop Master":
  ...
  "The Hesitant Stammer":
    "Remove the polish. Use ellipses, stammers, and self-corrections. The character is struggling to find words.",
  "The Aggressive Interrogator":
    "Flip the script. Instead of answering, the character should demand answers. Make them suspicious.",
  "The Sarcastic Deflection":
    "The character uses humor or sarcasm as a defense mechanism to deflect the seriousness.",
...
export function getDirectorInstruction(noteKey) {
  const instruction =
    DIRECTOR_NOTES[noteKey] || DIRECTOR_NOTES["The Internal State"];
