...
export function openDrawerFor(entityType, stateKey, previewId, button, triggerElement) {
...
export function renderEntityPreview(previewId, entity, slotButton, type, onEdit, isWorld = false, stateKey = null) {
