...
- [x] Fix dropdowns so titles can reopen hidden selects (HF-1).- [x] Truncate default storyboard titles to 80 characters.
- [x] Fix dropdowns so titles can reopen hidden selects (HF-1).
- [x] Cap autogenerated storyboard titles at 80 characters.
- [x] Toggle storyboard selects by clicking card headings.
