...
| Rule System Consolidation                | Reduce cognitive load; unify naming across docs/rules (AGENTS.md established as universal agent protocol) | M      | M      | MCP docs consolidation                        | approved    | Confusion in PR reviews about rule source of truth                                    |
...
| Build system: parallel/incremental v2    | Faster local dev cycles (esbuild integrated for ImageGlitch)             | M      | M      | Current build scripts                         | spiking     | Profiling shows build hot spots; prototype proves 2× speed                            |
