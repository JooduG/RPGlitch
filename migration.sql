...
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (8, 'entry_8', '{"relationship","trust","love","intimacy","bond","romance","[SYS_Relationship_Arc]","REL"}', '<RELATIONSHIP_GATES>
<TIERS>
...
</RELATIONSHIP_GATES>', '[SYS_Relationship_Arc]', 92, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (9, 'entry_9', '{"inventory","wound","object","promise","threat","[SYS_Chekhov]","anchor"}', '<OBJECT_PERMANENCE>
<RULE>
...
</OBJECT_PERMANENCE>', '[SYS_Chekhov]', 91, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (10, 'entry_10', '{"sex","intimacy","nsfw","combat","torture","gore","fuck","fucking","[SYS_NSFW_Modes]"}', '<NSFW_PHYSICS_ENGINE>
<DIRECTIVE>
...
</NSFW_PHYSICS_ENGINE>', '[SYS_NSFW_Mechanics]', 90, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (11, 'entry_11', '{"sex","position","mechanics","kama","missionary","doggy","cowgirl","prone","mating press","[SYS_Position_Library]"}', '<POSITION_MATRIX>
<INSTRUCTION>
Do not just name the position. Describe the **Anatomy**, **Leverage**, and **Sensory Output** based on the active Mode.
</INSTRUCTION>', '[SYS_Position_Library]', 89, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (12, 'entry_12', '{"Missionary","The Press","pin","pinning","pinned"}', '<ENTRY id="FRONTAL_PIN" aliases="Missionary, The Press">
...
</ENTRY>', 'Frontal Pin', 88, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (13, 'entry_13', '{"Doggy","Prone Bone","Face-Down"}', '<ENTRY id="REAR_ACCESS" aliases="Doggy, Prone Bone, Face-Down">
...
</ENTRY>', 'Rear Access ', 87, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (14, 'entry_14', '{"Mating Press","Legs-Over-Head","fold","folding","folded"}', '<ENTRY id="FULL_FOLD" aliases="Mating Press, Legs-Over-Head">
...
</ENTRY>', 'Full Fold', 86, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (15, 'entry_15', '{"Cowgirl","Riding","Lap"}', '<ENTRY id="VERTICAL_LOCK" aliases="Cowgirl, Riding, Lap">
...
</ENTRY>', 'Vertical Lock', 85, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (16, 'entry_16', '{"Standing","Wall-Pin","Carry","vertical","lift","lifted","pinned against"}', '<ENTRY id="SUSPENSION" aliases="Standing, Wall-Pin, Carry">
...
</POSITION_MATRIX>', 'Suspension', 84, true, '{}');
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (17, 'entry_17', '{"NPC","character","supporting","crowd","bartender","guard","person","stranger","crowd","bystander","Mirai","Akiko","Hana","Juul","servants","servant","Anna"}', '<NPC_PROTOCOLS>
<AGENCY>
...
</NPC_PROTOCOLS>', 'Entry 2: NPC Protocols', 83, true, '{}');
...
INSERT INTO lorebook_entries (uid, unique_key, keys, content, comment, priority, enabled, tags) VALUES (29, 'entry_29', '{"Fate","Temperance","Card XIV","front-temperance","balance","patience","moderation","synthesis","harmony","healing","compromise","adaptation"}', '[ARCHETYPE: Temperance (XIV)]
...
- Examples: Turning an insult into a joke, negotiating a compromise, mixing magic/items, patience.', '🃏 | Temperance', 71, false, '{}');
