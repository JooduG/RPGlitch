# RPGlitch Intelligence & Workflow Protocol (Sovereignty Axioms)

## 1. Nomenclature Sovereignty
- **Rule**: Never rename existing engine primitives without an ADR.
- **Context**: Simulation states, Round/Turn definitions, and Core State bridges must remain immutable.

## 2. Local Time Sovereignty
- **Rule**: All timestamps and scheduling must use Local Time.
- **Context**: The engine's Round clock is the master scheduler.

## 3. Absolute Mapping Sovereignty
- **Rule**: Every logic change must be mapped to its corresponding test file.
- **Context**: No code exists without verification.
