...
_Test artifacts: scratch/stress/round-0..10.json (per-round dumps), final-rounds.json (28-round DB table), final-entities.json (end-state entities), notes.md (running audit log)._
