...
- **Positive Triggers**: UI lag when switching entities, slow "Echo" persistence, animation jank in the Chalk Regime, or when exceeding performance budgets in `SPEC.md`.
