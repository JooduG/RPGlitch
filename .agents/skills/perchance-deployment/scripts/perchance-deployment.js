 ...
 *
 * Architecture:
 *   Left Panel  → src/RPGlitch-left-panel.pjs  → window.modelTextEditor
...
const CONFIG = {
  ...
  left_panel_path: resolve(PROJECT_ROOT, "src", "RPGlitch-left-panel.pjs"),
  max_bundle_size: 2 * 1024 * 1024, // 2MB limit for Perchance stability
