...
- \`.agents/archive/swarm/${YYYY_MM_DD}/issue_tasks.md\`
- \`.agents/archive/swarm/${YYYY_MM_DD}/issue_tasks.json\`
...
After you have written both \`.agents/archive/swarm/${YYYY_MM_DD}/issue_tasks.md\` and \`.agents/archive/swarm/${YYYY_MM_DD}/issue_tasks.json\`, run the dispatcher to spawn parallel Jules sessions for each task:
