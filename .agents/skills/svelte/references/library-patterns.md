...
This guide consolidates the fundamental reactivity macros (Runes) and the architectural patterns for integrating headless component libraries (Bits UI) within the RPGlitch Engine.
...
RPGlitch utilizes **Bits UI** for accessible, unstyled interaction primitives.
