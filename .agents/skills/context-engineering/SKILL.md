...
- **Sovereign Hierarchy**: Prioritize Rules (GEMINI.md) → Spec (SPEC.md) → Reality (Source code) → Feedback (Tests/Logs).
...
- **SPEC OVERRIDE**: If `SPEC.md` contradicts code, the Spec is the target reality.
