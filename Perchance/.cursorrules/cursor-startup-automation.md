---
description: Defines an automated startup process for Cursor to initialize tasks or sessions for any project, adapted from Cline's system.
author: Cursor
version: 1.0
...
# Cursor Startup Automation Rule

## Objective
This rule defines an automated startup process for Cursor to initialize tasks or sessions within any project. It automates the review of memory bank files, generation of summaries, and logging of critical context, ensuring consistency while maintaining flexibility.

## When to Apply This Rule
Cursor SHOULD apply this rule at the start of EVERY task or session within any project context. This rule is triggered automatically upon task initialization.
...
## Conclusion
This rule enables automated startup for any project, ensuring consistent initialization while maintaining Cursor's flexibility. 