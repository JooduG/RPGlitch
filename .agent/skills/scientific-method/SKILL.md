...
description: Hypothesis-driven experimentation for unknown problems.
---

# 🔮 Skill: Scientific Method

> **The Lab:** Testing the unknown.

## 1. When to Use

- **Complexity:** L6 (Science).
- **Trigger:** Performance tuning, "weird" bugs, unknown platform behavior.
- **Goal:** Empirical truth.
