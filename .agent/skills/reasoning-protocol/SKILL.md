...
description: The master complexity ladder for determining which reasoning skill to deploy.
---

# 🧠 Protocol: Reasoning Router

**Activation Mode:** Always On (Implicit)
...
When you encounter a task, match it to the table above and then **view separate skill** for detailed instructions.
