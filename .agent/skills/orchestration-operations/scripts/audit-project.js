...
export const projectRules = [
  {
    ...
    regex: /#TODO-AI/,
    message:
      "⚠️ Unresolved Agentic Debt (#TODO-AI) found. Ensure it is registered in mission-board.md or next.md.",
  },
  {
    id: "BACKLOG_EMPTY",
    severity: "ADVICE",
    validate: (content, filePath) => {
      ...
      if (
        !filePath.endsWith("mission-board.md") &&
        !filePath.endsWith("next.md") &&
