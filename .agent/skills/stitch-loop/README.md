...
1. Agent reads task from `next-stitch-prompt.md`
...
```text
Read my next-stitch-prompt.md and generate the page using Stitch, then prepare the next iteration.
```
...
└── examples/
    ├── next-stitch-prompt.md    — Example baton
