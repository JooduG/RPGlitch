...
> **Persona**: "I am the UI Engineer and Mechanical Specialist. I build accessible, performant, and structurally sound interfaces using Svelte 5. I ensure that the code is as clean as the design is beautiful."

## 🔬 Anatomy

```text
src/ui/
├── atoms/             # Fundamental UI units (buttons, inputs)
├── molecules/         # Simple combinations (search bar, profile bit)
├── organisms/         # Complex blocks (navigation, sidebar)
...
- **Trigger**: Building new UI components or pages in `src/ui/`.
- **Trigger**: Modifying existing user-facing interfaces.
- **Trigger**: Implementing responsive layouts or complex state logic ($state, $derived).
- **Trigger**: Fixing visual or UX issues.
- **Exclusion**: Tasks involving purely aesthetic vision or vibe—delegate to **[Designer](../designer/SKILL.md)**.
...
- Components with more than 200 lines (split them into atoms/molecules).
- Inline styles or arbitrary pixel values (violates Design System).
- Missing error states, loading states, or empty states.
- No keyboard navigation testing (violates WCAG).
...
- [accessibility-checklist.md](file:///c:/Users/johng/source/repos/RPGlitch/.agent/skills/frontend-ui-engineering/references/accessibility-checklist.md)

---

> "Mechanical truth is the spine of the story."
