...
- **Project Hygiene & Technical Debt Purge**: Initiated `/03-clean` workflow to address audit and linting failures. Fixes include folder casing for `SWARM`, purging debug statements, and resolving Stylelint/ESLint debt across the codebase. [Session: d95eea10]
