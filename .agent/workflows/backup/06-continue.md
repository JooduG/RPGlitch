---
name: 06-continue
description: Recovery Protocol (The Relay). Resumes work after an unexpected interruption.
---
...
- **Next Prompt / Execution Baton**: `.agent/state/next-prompt.md`
- **Checkpoint Deltas**: `.agent/state/tracks.md`
