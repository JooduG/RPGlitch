...
- **Tracks**: `.agent/state/tracks.md`
- **Plan**: `.agent/state/tracks/<slug>/<slug>.md` (Flat — Spec + Plan combined)
- **Spec**: Embedded in `.agent/state/tracks/<slug>/<slug>.md`
...
2.  **Update Tracks**: Update global status in `.agent/state/tracks.md`. **Mandatory**: Use the "Track Block" format.
...
4.  **Interactive Track Cleanup**: If the track is 100% complete, do NOT automatically archive the folder. Prompt the user: "Track is
   complete. Do you want to **Review**, **Archive**, **Delete**, or **Skip**?".
       ...
       - Move the file to `.agent/archive/state/tracks/`.
