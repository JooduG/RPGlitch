...
- **The Baton**: `STATE.md` (To understand current reality)
...
2. **Read the Baton**: Read `STATE.md` at the root of the project to understand the current reality of the UI and engine.
...
- **Constraints**: [List restrictions based on `05-standards.md` and `STATE.md`]
...
- **Ignoring Constraints**: Failing to check `STATE.md` to see if the requested vibe conflicts with a Known Quirk or active Svelte 5 paradigm.

## 5. Tools

- `view_file` / `read_file` (To read STATE.md)
