...
1. **Purge**: Delete unused assets and legacy artifacts. [[Invoke: methodology]](../skills/methodology/SKILL.md)
...
2. **Scrub**: Remove `console.log` and temporary debugging artifacts. [[Invoke: methodology]](../skills/methodology/SKILL.md)
