...
Invoke the [Code Simplification](../skills/code-simplification/SKILL.md) skill.
...
If tests fail after a simplification, revert that change and reconsider. Use [Code Review & Quality](../skills/code-review-and-quality/SKILL.md) to review the result.
