...
2. **Supplemental Parsing**: If the chat log is ambiguous or insufficient, scan the [Log Book](../../tasks/todo.md) and current [task.md] for the active track `[/]`. Identify the last successful action and the next pending step. [[Invoke: using-agent-skills]](../skills/using-agent-skills/SKILL.md)
