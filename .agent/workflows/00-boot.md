...
- **Rules**: [.agent/rules/03-infrastructure.md](../rules/03-infrastructure.md).
...
1. **Intake**: Read [.agent/state/global.md](../state/global.md), [.agent/state/tracks.md](../state/tracks.md), and [.agent/state/backlog.md](../state/backlog.md). [[Invoke: agent-forge]](../skills/agent-forge/SKILL.md)
...
3. **Validation**: Ensure the Mission Board is not corrupted and contains valid Markdown. Do not advance until the state matrix is fully parsed. [[Invoke: methodology]](../skills/methodology/SKILL.md)

### Phase 2: Registry

1. **Registry**: Identify any active track `[/]` or pending tasks `[ ]` in [.agent/state/tracks.md](../state/tracks.md). [[Invoke: methodology]](../skills/methodology/SKILL.md)
