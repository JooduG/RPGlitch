...
1. Read `.agent/product.md` (Gain understanding of the product).
2. Read `.agent/rules/tech-stack.md` (Gain understanding of constraints).
3. Read `.agent/tasks/tracks.md` (Check for duplicates).
...
4. Update Registry:
    - Append to `.agent/tasks/tracks.md`:
