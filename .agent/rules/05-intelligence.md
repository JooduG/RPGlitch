...
- **Cleanup**: Upon mission completion (`[DONE]`), delete the blueprint file entirely to comply with Rule 06 strict zero-trust hygiene policy. Do not archive it to other files like `walkthrough.md`.
