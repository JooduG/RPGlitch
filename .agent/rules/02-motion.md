...
description: Workflow protocols, Clarity Gates, and the Execution Registry.
...
`Input -> Ambiguity Check (A) -> Complexity Selection (C) -> Quality Gate (Q) -> Output`
...
- [ ] Tests pass (Unit/E2E).
- [ ] Security sanitization (**🛡️ Shield**) applied.
- [ ] Walkthrough documented.

## 5. Workflow Registry (The Red Thread)
