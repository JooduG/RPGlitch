# 🗺️ Discovery Map: Knowledge Nexus

Welcome to the **Antigravity OS** knowledge base. This is a narrative-driven map designed for exploration, discovery, and systems alignment.

---

## 🔴 The Core (Vision & Experience)

_Theme: The Soul and the Body_
Centered around the **Mesmer** and **Artificer** pillars. This is where the world's atmosphere is defined and its structure is built.

- [The Philosophy of Minimalism](./vision/philosophy.md) — _Mesmer_
...
## 🧪 The Incubator (Speculation & Evolution)

_Theme: The Forge_
Speculative concepts, lore experiments (ANEX), and the future roadmap. These ideas are distinct from the canon system and live in a state of development.

- [Lorebook Specification (ANEX)](./incubator/lorebook-spec.md)
- [Experimental Mechanics Concepts](./incubator/mechanics-concepts.md)
- [Experimental Immersion Concepts](./incubator/immersion-concepts.md)
- [Feature Roadmap Incubator](./incubator/roadmap-ideas.md)
- [The Speculation Archive](./incubator/speculation/) — _Raw Assets & Data_
...
> **Operational Note:** All files are normalized to reflect Pillar ownership while preserving thematic folder resonance. Folder names (e.g., `tech`, `vision`, `logic`) represent thematic zones, while headers represent Pillar authority.
