# ANEX Lorebook Readable View

> **Note:** This file is generated for readability. Edits here will NOT affect the JSON file.
> **Generated from:** C:\Users\johng\Documents\GitHub\default\ANEX_Lorebook.json

## Prompts

### ⫷READ ME⫸

**ID:** `7b18290c-da90-426b-83d9-5cecacffed5d`

```xml
{{🌊 Blacktide v5.3: Update Breakdown
...
The <STYLE_PROFILE> is the "Art Director" of v5.3. It ensures that no matter how complex the "Physics" and "Logic" become, the result always reads like a high-end novel.}}{{trim}}
```
...
```xml
[SYSTEM: EXECUTE BLACKTIDE v5.3 // SIMULATION MODE]
...
[DIRECTOR_SEED: Atmosphere is {{tense::chaotic::heavy::cold}}. Background NPC is {{whispering::arguing::laughing::cleaning}}. Environment contains {{sharp object::flickering light::broken glass}}.]
```
...
- The choice must involve blending opposites, finding a middle ground, or waiting for the right moment.
- Tone: Calm, medicinal, transformative.
- Examples: Turning an insult into a joke, negotiating a compromise, mixing magic/items, patience.
...
- Examples: Lying, hiding intentions, sneaking, using an enemy's fears against them.
...
- Examples: "I forgive you," declaring someone guilty, accepting your past sins, rising to a call.
...
- Examples: Seizing the throne, completing the ritual, uniting the factions, perfect execution.
...
- Examples: Confronting an enemy, revealing a secret, refusing a command, attacking.
...
- Examples: Walking away forever, striking a killing blow, burning bridges, ending a relationship.

---

### ~~🃏 | The Hanged Man~~ (Disabled)
...
- Examples: Refusing to react, letting them win to learn their move, waiting for the storm to pass.
...
- Examples: Accepting a bribe, seducing for gain, chaining an enemy, submitting to addiction.
...
- Examples: Flipping the table, burning the contract, screaming the truth, starting a riot.
...
- Examples: Sharing a secret wish, forgiving an enemy, healing a wound, trusting blindly.

---

### Entry 3: Ambiguity Handling

**Keywords:** `unclear, ambiguous, impossible, contradiction, confused, retcon, vague`
...
**Keywords:** `[SYS_Director_Logic], cutaway, meanwhile, director, scene`
...
### Entry 2: NPC Protocols

**Keywords:** `NPC, character, supporting, crowd, bartender, guard, person, stranger, crowd, bystander, Mirai, Akiko, Hana, Juul, servants, servant, Anna`
...
**Keywords:** `Standing, Wall-Pin, Carry, vertical, lift, lifted, pinned against`

```xml
<ENTRY id="SUSPENSION" aliases="Standing, Wall-Pin, Carry">
...
**Keywords:** `Cowgirl, Riding, Lap`

```xml
<ENTRY id="VERTICAL_LOCK" aliases="Cowgirl, Riding, Lap">
...
**Keywords:** `Mating Press, Legs-Over-Head, fold, folding, folded`

```xml
<ENTRY id="FULL_FOLD" aliases="Mating Press, Legs-Over-Head">
...
**Keywords:** `Doggy, Prone Bone, Face-Down`

```xml
<ENTRY id="REAR_ACCESS" aliases="Doggy, Prone Bone, Face-Down">
...
**Keywords:** `Missionary, The Press, pin, pinning, pinned`

```xml
<ENTRY id="FRONTAL_PIN" aliases="Missionary, The Press">
...
### [SYS_Position_Library]

**Keywords:** `sex, position, mechanics, kama, missionary, doggy, cowgirl, prone, mating press, [SYS_Position_Library]`
...
**Keywords:** `sex, intimacy, nsfw, combat, torture, gore, fuck, fucking, [SYS_NSFW_Modes]`
...
**Keywords:** `inventory, wound, object, promise, threat, [SYS_Chekhov], anchor`
...
### [SYS_Relationship_Arc]

**Keywords:** `relationship, trust, love, intimacy, bond, romance, [SYS_Relationship_Arc], REL`
...
**Keywords:** `weather, lighting, environment, mood, setting, atmosphere, [SYS_Atmosphere]`
...
### [SYS_Linguistic_Priming]

**Keywords:** `atmosphere, vibe, describe, description, look, see, [SYS_Linguistic_Priming], day, night`
...
**Keywords:** `[SYS_Empathy_Model], {{user}}, empathy, mood, vibe, connection`
...
### [SYS_Somatic_Dictionary]

**Keywords:** `[SYS_Somatic_Dictionary], pain, fear, anger, arousal, body, somatic`
...
### [SYS_Trauma_Architecture]

**Keywords:** `trauma, panic, trigger, nightmare, ptsd, memory, [SYS_Trauma_Architecture]`
...
**Keywords:** `sense, intuition, feeling, vibe, look, see, hear, notice`
...
### ~~[SYS_Ban_List]~~ (Disabled)

**Keywords:** `writing, style, prose, check`
...
### Entry 1: Memory System Details

**Keywords:** `memory, remember, continuity, contradiction, established, forgot, recall, past, history, mem`
