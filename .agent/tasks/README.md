...
- `tracks.md`: The global registry of active, planned, and completed work tracks.
- `<track-name>/`: Individual folders for complex features, containing `spec.md` and `plan.md`.
